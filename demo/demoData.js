...
const CATALOG = {
  ...
  メロン: [
    ["アールスメロン", 480, 7], ["夕張メロン", 390, 6],
    ["アンデスメロン", 180, 6], ["クインシー", 110, 7],
  ],
  みかん: [
    ["温州みかん", 520, 12], ["デコポン", 310, 3],
    ["せとか", 210, 2], ["はるみ", 130, 2], ["清見", 90, 3],
  ],
  すいか: [["大玉スイカ", 340, 7], ["小玉スイカ", 150, 7], ["黒皮スイカ", 95, 8]],
  マンゴー: [["アップルマンゴー", 290, 6], ["キーツマンゴー", 120, 8]],
  いちじく: [["桝井ドーフィン", 160, 9], ["蓬莱柿", 85, 10]],
  ブルーベリー: [["ハイブッシュ", 140, 7], ["ラビットアイ", 95, 8]],
  栗: [["丹波栗", 210, 10], ["利平栗", 120, 9], ["ぽろたん", 70, 10]],
  柑橘: [["レモン", 180, 11], ["ゆず", 130, 11], ["きんかん", 60, 1]],
  ネクタリン: [["ファンタジア", 90, 8], ["秀峰", 55, 8]],
  びわ: [["茂木びわ", 110, 6], ["長崎早生", 60, 5]],
};
